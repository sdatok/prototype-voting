                ...
                <form action="#" method="POST" class="space-y-4 px-4 py-6">
                    ...
                    <div>
                        <select name="category_add" id="category_add"
                            class="w-full bg-gray-100 rounded-xl text-sm border-none px-4 py-2">
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        <button type="button"
                            ...
                            <svg class="text-gray-500 h-6 w-5 transform -rotate-45" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
